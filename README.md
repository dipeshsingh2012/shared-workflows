...
| **Deploy to Vercel** | [`.github/workflows/deploy-vercel.yml`](.github/workflows/deploy-vercel.yml) | Deploys React / Next.js / Vite web frontends to Vercel via Vercel CLI with production and preview environments. |
